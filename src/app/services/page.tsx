...
const services = [
  ...
  },
  {
    ...
    title: "Design & Build",
    description:
      "We specialize in the comprehensive design and construction of real estate properties, encompassing every facet of your project.",
  },
  {
    icon: "https://res.cloudinary.com/dbczzmftw/image/upload/v1753375852/qqtjiyaawpw0xm52u8k4.svg",
    title: "Facility Management",
    description:
      "We offer a comprehensive range of tools and services that are specifically designed to enhance the functionality, safety, and sustainability of your real estate assets.",
  },
  {
    icon: "https://res.cloudinary.com/dbczzmftw/image/upload/v1753375878/lclkkocsj2eolcarvcn8.svg",
    title: "Consulting Service",
    description:
      "As industry leaders, we are committed to providing you with a comprehensive spectrum of solutions that empowers you to navigate the real estate landscape with confidence.",
  },
  {
    icon: "https://res.cloudinary.com/dbczzmftw/image/upload/v1753375904/mjvxtztzdhv7icb36nf6.svg",
    title: "Our Approach",
    description:
      "Our success is built on a foundation of collaboration and synergy. We seamlessly blend creativity and technical competence through direct cooperation among our team.",
  },
];
...
const testimonials = [
  {
    name: "Mrs. Fred",
    quote:
      "So far so good, Strongmas services are really fantastic and the area of their property is fantastic. The quality of work is also fantastic and i look forward to more beneficial relationship. Strongmas equals fantastic to me.",
  },
  {
    name: "Mr. Kunle",
    quote:
  ...
  },
  {
    name: "Mr. Ade",
    quote:
      "The team at Strongmas is professional, attentive, and incredibly skilled. They transformed our vision into a reality that exceeded all our expectations. Highly recommended!",
  },
];
              ...
              {services.map((service, index) => (
                ...
                >
                  ...
                  <div className="p-6 md:p-8 text-left pl-0 p-unset">
                    ...
                    <p className="font-body font-normal text-lg leading-relaxed text-[#F8F8FA]">
                      {service.description}
                    </p>
                  </div>
                </div>
