      ...
      <main className="flex-grow pt-20">
        <section className="relative h-[40vh] md:h-[50vh] bg-black">
          ...
          <div className="relative z-10 h-full flex flex-col justify-center items-start text-white container mx-auto px-4 sm:px-6 lg:px-8">
            <h1 className="text-3xl md:text-5xl font-bold font-headline">GET TO KNOW US</h1>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="text-white order-first lg:order-last px-4 sm:px-0">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Our zero-energy consumption homes blend architectural excellence with cutting-edge
                  smart technologies and eco-conscious design. STRONGMAS delivers livable spaces
                  that transform lives, create lasting value, and build legacies for a discerning
                  global clientele. With an expansion focus across Africa, we are committed to
                  redefining how luxury and sustainability coexist in the built environment.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12 md:mb-20">
              ...
              <div className="bg-gray-50 p-8 rounded-lg shadow-sm flex flex-col items-center text-center">
                ...
                <h3 className="text-2xl font-bold font-headline text-gray-900 mb-4">OUR VISION</h3>
                <p className="text-lg leading-relaxed text-gray-700">
                  To redefine Africa’s urban landscape through timeless design, intelligent
                  innovation, and enduring lifestyle excellence.
                </p>
              </div>
            </div>
              ...
              <div className="relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                  ...
                  <div className="bg-white/10 p-8 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300 flex flex-col items-center text-center backdrop-blur-sm">
                    ...
                    <p className="text-gray-200 leading-relaxed">
                      Our clients are at the heart of everything we do. We provide seamless,
        ...
        <section className="py-16 sm:py-24 bg-black text-white font-sans">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-4xl mx-auto">
              <h2 className="text-3xl md:text-4xl font-bold font-headline mb-6">WHAT WE OFFER</h2>
              <p className="text-muted-foreground leading-relaxed">
                Whether for living or investment, explore our current projects and discover the
                finest in modern residential and commercial properties, designed to meet your
                highest standards. At Strongmas, we offer a wide range of residential and commercial
