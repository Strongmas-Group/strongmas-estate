...
export default function PropertyPage() {
  ...
  const property = properties.find((p) => p.name.toLowerCase().replace(/\s+/g, "-") === slug);
          ...
          <div className="py-12 md:py-16">
            <Tabs defaultValue="description" className="w-full">
              ...
              <TabsContent value="description" className="pt-8">
                <p className="text-gray-600 leading-relaxed max-w-4xl">{property.description}</p>
              </TabsContent>
              {property.availableUnits && (
                ...
                <TabsContent value="virtualtour" className="pt-8">
                  <div className="w-full">
                    ...
                    <p className="text-gray-600 mb-6 text-center text-sm md:text-base">
                      Take an immersive virtual tour of this property. Use your mouse or touch to
                      navigate and explore every corner.
                    </p>
                    ...
                    <div className="mt-4 text-center">
                      <p className="text-xs md:text-sm text-gray-500">
                        For the best experience, use fullscreen mode. On mobile, rotate to landscape
                        for optimal viewing.
                      </p>
                    </div>
          ...
          <section className="py-16 sm:py-24 bg-gray-50 font-sans">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                {allFeatures.map((feature: { feature?: string } | string, index: number) => (
