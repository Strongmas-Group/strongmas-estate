...
import CountUp from "@/components/custom/count-up";
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-y-8 gap-x-4">
        {stats.map((stat) => (
          <div key={stat.label} className="text-center flex flex-col items-center px-2">
            ...
            />
            <p className="text-3xl sm:text-4xl md:text-5xl font-bold text-primary font-headline whitespace-nowrap tabular-nums">
