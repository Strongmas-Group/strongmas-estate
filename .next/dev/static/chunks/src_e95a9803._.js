...
function TawkChat() {
    ...
    `;
            ...
            script.onload = ({
                "TawkChat.useEffect": ()=>{
                    ...
                    const checkInterval = setInterval({
                        "TawkChat.useEffect.checkInterval": ()=>{
                            if (window.Tawk_API) {
                                ...
                                try {
                                    ...
                                    window.Tawk_API.showWidget = ({
                                        "TawkChat.useEffect.checkInterval": ()=>{
                                            console.log('Blocked showWidget');
                                        }
                                    })["TawkChat.useEffect.checkInterval"];
                                    window.Tawk_API.hideWidget = ({
                                        "TawkChat.useEffect.checkInterval": ()=>{
                                            console.log('Blocked hideWidget');
                                        }
                                    })["TawkChat.useEffect.checkInterval"];
                                    window.Tawk_API.toggle = ({
                                        "TawkChat.useEffect.checkInterval": ()=>{
                                            console.log('Blocked toggle');
                                        }
                                    })["TawkChat.useEffect.checkInterval"];
                    ...
                    }["TawkChat.useEffect.checkInterval"], 100);
                }
            })["TawkChat.useEffect"];
            document.body.appendChild(script);
            // 3. Function to aggressively remove any Tawk buttons
            const removeTawkButtons = {
                "TawkChat.useEffect.removeTawkButtons": ()=>{
                    // Direct DOM removal
                    const elementsToRemove = document.querySelectorAll('.tawk-button, .tawk-button-container, .tawk-min-container, ' + '.tawk-button-circle, [id*="tawk"], [class*="tawk"], ' + 'button[title*="Tawk"], div[data-tawk], .tawk-visitor, .tawk-widget');
                    elementsToRemove.forEach({
                        "TawkChat.useEffect.removeTawkButtons": (el)=>{
                            if (el && el.parentNode) {
                                el.remove();
                            }
                        }
            ...
            const observer = new MutationObserver({
                "TawkChat.useEffect": (mutations)=>{
                    let shouldRemove = false;
                    mutations.forEach({
                        "TawkChat.useEffect": (mutation)=>{
                            if (mutation.addedNodes.length) {
                                mutation.addedNodes.forEach({
                                    "TawkChat.useEffect": (node)=>{
                                        if (node.nodeType === 1) {
                                            const el = node;
                                            if (el.className?.includes?.('tawk') || el.id?.includes?.('tawk') || el.id?.includes?.('Tawk') || el.className?.includes?.('Tawk') || el.getAttribute?.('class')?.includes?.('tawk') || el.getAttribute?.('id')?.includes?.('tawk')) {
                                                setTimeout({
                                                    "TawkChat.useEffect": ()=>{
                                                        if (el && el.parentNode) {
                                                            el.remove();
            ...
            const handleResize = {
                "TawkChat.useEffect.handleResize": ()=>{
                    positionChatOnLeft();
                    removeTawkButtons();
                }
            }["TawkChat.useEffect.handleResize"];
...
_s(TawkChat, "sh8M22v0kNG1w78vmMFzn93ThZo=");
_c = TawkChat;
var _c;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$tawk$2d$chat$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/tawk-chat.tsx [app-client] (ecmascript)");
;
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("body", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$tawk$2d$chat$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                        fileName: "[project]/src/app/layout.tsx",
                        lineNumber: 112,
                        columnNumber: 9
                    }, this)
...
//# sourceMappingURL=src_e95a9803._.js.map