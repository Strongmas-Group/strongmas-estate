...
function useAnalytics() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useAnalytics.useEffect": ()=>{
            var _window_gtag, _window;
            if (!pathname) return;
            const url = pathname + ((searchParams === null || searchParams === void 0 ? void 0 : searchParams.toString()) ? "?".concat(searchParams.toString()) : "");
            (_window_gtag = (_window = window).gtag) === null || _window_gtag === void 0 ? void 0 : _window_gtag.call(_window, "config", "G-EKX1W7G2KJ", {
                page_path: url
            });
        }
    }["useAnalytics.useEffect"], [
...
//# sourceMappingURL=src_03782dc2._.js.map